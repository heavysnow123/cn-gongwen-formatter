...
一个开源的中文文档（Word / TXT / Markdown）智能排版工具，面向中文公文与报告场景。
它能自动识别标题层级、统一字体版式、标准化中英文标点，并生成可导航的大纲，
把格式混乱的文档一键整理成规范排版。
...
- **公文字体检查**：排版前检测系统是否安装公文常用字体（仿宋_GB2312 / 楷体_GB2312 等），
...
公文版式要求正文用仿宋_GB2312、部分标题用楷体_GB2312；系统缺失时排版软件会回退替代字体，
导致不达标。本工具**只检查、不安装**——字体安装属于系统级修改且涉及授权分发，由用户自行完成。
